 ...
 * @throws If required parameters are missing in the configuration
 */
export declare const validateSyncRecordConfiguration: (config: ListRecordsRequestConfig) => void;
export declare function getUserAgent(userAgent?: string): string;
export declare function addQueryParams(url: URL, queries?: Record<string, any>): void;
