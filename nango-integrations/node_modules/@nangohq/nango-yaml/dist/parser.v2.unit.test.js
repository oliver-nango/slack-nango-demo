...
import { ParserErrorBothPostConnectionScriptsAndOnEventsPresent, ParserErrorDuplicateEndpoint, ParserErrorMissingId, ParserErrorModelIsLiteral, ParserErrorModelNotFound } from './errors.js';
...
describe('parse', () => {
    it('should parse', () => {
        ...
        expect(parser.parsed).toStrictEqual({
            integrations: [
                {
