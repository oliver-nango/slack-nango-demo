...
describe('PaginationService', () => {
    describe('cursor pagination', () => {
        ...
        let proxy; // Use ReturnType for type inference
        beforeEach(() => {
            config = {
                endpoint: '/test',
                method: 'POST',
        ...
        describe('dot notation handling', () => {
            it('should expand dot notation in body parameters', async () => {
                const generator = PaginationService.cursor(config, paginationConfig, { 'pagination.per_page': 150 }, true, // passPaginationParamsInBody = true
                proxy);
            ...
            it('should handle multiple levels of dot notation', async () => {
                const generator = PaginationService.cursor(config, paginationConfig, {
            ...
            it('should not expand parameters when passing in query params', async () => {
                const generator = PaginationService.cursor(config, paginationConfig, { 'pagination.per_page': 150 }, false, // passPaginationParamsInBody = false
                proxy);
                await generator.next();
                expect(proxy).toHaveBeenCalledWith(expect.objectContaining({
                    params: {
            ...
            it('should handle updates to cursor with dot notation', async () => {
                ...
                expect(proxy).toHaveBeenNthCalledWith(2, expect.objectContaining({
                    data: {
                        pagination: {
                            per_page: 150,
...
//# sourceMappingURL=paginate.service.unit.test.js.map