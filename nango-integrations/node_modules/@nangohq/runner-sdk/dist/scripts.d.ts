...
export interface CreateActionResponse<TInput extends z.ZodTypeAny, TOutput extends z.ZodTypeAny, TMetadata extends ZodMetadata = undefined> extends CreateActionProps<TInput, TOutput, TMetadata> {
    type: 'action';
}
/**
 ...
 */
export declare function createOnEvent<TMetadata extends ZodMetadata = undefined>(params: CreateOnEventProps<TMetadata>): CreateOnEventResponse<TMetadata>;
