...
function showCompilationMessage(failedFiles) {
    if (failedFiles.size === 0) {
        console.log(chalk.green('Compilation success! Watching files…'));
    }
}
export function tscWatch({ fullPath, debug = false, watchConfigFile }) {
    ...
    let parsed = loadYamlAndGenerate({ fullPath, debug });
