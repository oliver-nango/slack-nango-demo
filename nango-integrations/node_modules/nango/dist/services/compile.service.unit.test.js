...
describe('listFiles', () => {
    ...
    it('should list files with syncName', () => {
        const files = listFilesToCompile({ scriptName: 'compile.service', scriptDirectory: '', fullPath: thisFolder, parsed: {} });
    ...
    it('should list files in subdirectory', () => {
        ...
        const files = listFilesToCompile({ scriptName: 'compile.service', fullPath: parent, scriptDirectory: 'services', parsed: {} });
        expect(files.length).toBe(1);
        expect(files[0]).toStrictEqual({
            baseName: 'compile.service',
...
//# sourceMappingURL=compile.service.unit.test.js.map