 ...
 */
export function loadYamlAndGenerate({ fullPath, debug = false }) {
    if (debug) {
...
export function loadSchemaJson({ fullPath }) {
 ...
 * Build models.ts
 */
export function buildModelsTS({ parsed }) {
    return `// ---------------------------
...
export function generateInterfaces({ parsed }) {
    const interfaces = [];
 ...
 */
export function modelToTypescript({ model }) {
    const output = [];
    if (model.isAnon) {
...
export function fieldsToTypescript({ fields }) {
    const output = [];
 ...
 */
export function fieldToTypescript({ field }) {
    let output = '';
...
export function generateAdditionalExports({ fullPath, parsed, debug }) {
...
export function getExportToTS({ parsed }) {
    return `// ---------------------------
// This file was generated by Nango (v${NANGO_VERSION})
...
export function getExportToJSON({ pathTS }) {
    const schema = tsj
        .createGenerator({
        path: pathTS,
        type: '*',
