...
export function parse(fullPath, debug = false) {
    if (debug) {
    ...
    try {
        ...
        return Err(new CLIError('error_loading_nango_yaml', err instanceof Error ? err.message : err));
    }
}
/**
 * Output validation errors to console
 */
export function validateAndOutput(yaml) {
