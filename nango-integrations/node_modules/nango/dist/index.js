...
class NangoCommand extends Command {
    createCommand(name) {
        ...
        cmd.hook('preAction', async function (actionCommand) {
...
program
    .name('nango')
    .description(`The CLI requires that you set the NANGO_SECRET_KEY_DEV and NANGO_SECRET_KEY_PROD env variables.
...
program
    .command('compile')
    .description('Compile the integration files to JavaScript and update the .nango directory. This is useful for one off changes instead of watching for changes continuously.')
    .action(async function () {
...
program
    ...
    .action(async function (sync, connectionId) {
