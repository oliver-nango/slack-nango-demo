...
export async function initAI({ absolutePath, aiOpts, debug = false }) {
...
async function initCursor({ absolutePath, debug = false }) {
    try {
...
async function initClaude({ absolutePath, debug = false }) {
    try {
